 ...
 */
function LaterServer(storage) {
    EventEmitter.call(this);

    prop.internal(this, "servers", []);
    prop.internal(this, "storage", storage);
 ...
 * @param {LaterStorage} storage
 */
LaterServer.create = function(storage) {
    return new LaterServer(storage);
};
...
/**
 * Queue a request.  Return a Promise which resolves to the storage key.
 * @param {http.IncomingMessage} req
 * @returns {Promise}
 */
LaterServer.prototype.queue = function(req) {
